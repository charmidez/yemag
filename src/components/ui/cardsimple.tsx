...
export function Cardsimple({
  ...
  return (
    <>
        <div className="card lg:card-side bg-mine-redlight rounded-mine-rounded">
          <Image
            src={imgSrc}
            alt="Image"
            className="lg:w-100 object-cover lg:rounded-l-mine-rounded md:rounded-t-mine-rounded lg:rounded-r-mine-carre"
            width={2000}
            height={2000}
          />
